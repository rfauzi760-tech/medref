...
import { milestoneAges, milestoneDomains, milestoneForAge } from "@/lib/data/milestones";
...
export default function DevelopmentPage() {
  ...
  const entry = useMemo(() => (Number.isFinite(effectiveAge) ? milestoneForAge(effectiveAge) : null), [effectiveAge]);
