  ...
  },
  {
    ...
    sections: {
      ...
      initialAssessment: [
        ...
        "Sinkronkan langkah: napas tidak adekuat/menegap → ventilasi tekanan positif (VTP) dengan sungkup.",
      ],
      initialManagement: [
    ...
    references: [
      { org: "Kementerian Kesehatan RI", title: "Buku Panduan Pelayanan Kesehatan Neonatal Esensial (MTBS-neonatal) / Resusitasi Neonatus", year: 2021 },
      { org: "Weiner GM (AAP)", title: "Textbook of Neonatal Resuscitation (NRP), 8th ed.", year: 2021 },
    ],
    lastReviewed: "2025-06-01",
  },
];
