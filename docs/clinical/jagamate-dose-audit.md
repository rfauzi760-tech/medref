# Audit Obat Tunggal Jaga Mate untuk RFSmed
...
|---:|---|---|---|
| 1 | Asam Mefenamat | asam-mefenamat | Tercakup; dosis anak memerlukan batas usia dan indikasi yang tegas. |
| 2 | Ibuprofen | ibuprofen | Tercakup; sediaan oral sudah ada. |
| 3 | Kalium Diclofenac | diklofenak | Tunda; garam kalium tidak boleh disamakan otomatis dengan seluruh regimen diklofenak. |
| 4 | Ketorolac | ketorolak | Tercakup; rute parenteral dan batas lama terapi perlu telaah terpisah. |
...
- Parasetamol suspensi oral 160 mg/5 mL: [label DailyMed](https://dailymed.nlm.nih.gov/dailymed/fda/fdaDrugXsl.cfm?setid=debfa787-7a48-48b5-94b0-612820524032&type=display). Konsentrasi adalah spesifik produk; dosis berat badan tetap mengikuti regimen RFSmed yang sudah ada. Periksa label kemasan sebelum konversi.
