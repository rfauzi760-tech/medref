...
type ScoreSummary = Pick<ScoreTool, "slug" | "title" | "abbreviation" | "description" | "specialties" | "keywords" | "category">;
...
export default function ScoresPageClient({ scores }: { scores: ScoreSummary[] }) {
