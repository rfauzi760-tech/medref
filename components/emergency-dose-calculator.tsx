...
export default function EmergencyDoseCalculator() {
  ...
  return <div><BackLink href="/igd-toolkit" label="Kembali ke Toolkit IGD" /><PageHeader title="Kalkulator Dosis Obat IGD" description="Hitung dosis berbasis berat badan dan laju infus. Verifikasi konsentrasi sediaan sebelum pemberian." />
